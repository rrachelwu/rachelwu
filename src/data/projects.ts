...
export const projects: Project[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      { caption: "", title: "供应链后台 · 案例库管理", image: "/77feff48-0f98-4c56-acc7-cae0fa520d09.png", description: "买家成品案例与型号、订单数据关联展示，用户通过案例可直接查看对应轮毂的规格、型号与工艺详情，一键定制同款，降低定制门槛，推动规模化量产" },
    ...
    deliverablesEn: [
      ...
      { caption: "", title: "Supply Chain Backend · Case Library", image: "/77feff48-0f98-4c56-acc7-cae0fa520d09.png", description: "Buyer finished-product cases linked with model and order data, enabling users to view specs, models and process details directly, one-click custom ordering to reduce barriers and drive mass production" },
