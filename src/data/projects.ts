...
export const projects: Project[] = [
  ...
  },
  {
    id: "4",
    slug: "juzhengyuan",
    title: "矩阵元产品设计 — 区块链钱包与密钥管理平台的设计体系建设",
    titleEn: "Juzhengyuan Product Design — Design System for Blockchain Wallet & Key Management Platform",
    coverImage: "/placeholder.svg",
    summary: "在矩阵元（深圳）担任产品设计师期间，独立负责两条产品线的完整设计：面向个人用户的Privacy Wallet区块链钱包（App），以及面向企业用户的MPC-KMS密钥管理系统（Web后台+官网），从视觉规范到交互体系全面交付。",
    summaryEn: "As product designer at Juzhengyuan (Shenzhen), independently led the complete design of two product lines: Privacy Wallet blockchain wallet (App) for individual users, and MPC-KMS key management system (Web dashboard + website) for enterprise users, delivering from visual specs to interaction systems.",
    ...
    backgroundEn: "Juzhengyuan had two business lines advancing simultaneously: Privacy Wallet needed a complete redesign of the legacy ATON app without disrupting existing user habits; MPC-KMS was a brand-new product requiring brand visuals, dashboard, and website built from scratch. Both lines needed design language consistency while serving different tonal needs — 'secure & private' for the C-side wallet and 'professional & efficient' for the B-side dashboard.",
    decisions: [
      {
