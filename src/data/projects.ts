...
export const projects: Project[] = [
  ...
  },
  {
    ...
    deliverables: [
      { caption: "Mini App主页截图" },
      { caption: "核心流程页面截图（提交需求/订单跟踪）" },
      { caption: "与Web端对比示意（改版前后）" },
    ],
    deliverablesEn: [
      { caption: "Mini App homepage" },
      { caption: "Core flow pages (submit request / order tracking)" },
      { caption: "Before/after comparison with web version" },
    ],
    results: [
