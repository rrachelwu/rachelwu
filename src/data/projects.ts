...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: "轮毂定制与报价网站，设计B2B合作说明与优势表达，提升询盘沟通效率",
    summaryEn: "Custom wheel quotation website with B2B cooperation description and advantage presentation",
    role: "产品设计 / 商业化信息呈现",
    roleEn: "Product Design / Commercial Information",
    duration: "2025",
    durationEn: "2025",
    tags: ["B2B", "报价系统", "多语言"],
    ...
    sections: [
      {
        title: "项目背景",
        content: "设计报价信息结构：基础价 + 附加工艺、起订量规则、汇率结算说明，减少反复沟通成本。",
        images: [],
      },
      {
        title: "我的职责",
        content: "- 输出面向 B2B 的合作说明与优势表达（经销商/批发商/车队/OEM）\n- 提升询盘沟通效率\n- 中英俄三语适配，确保信息清晰、专业且可落地",
        images: [],
      },
      {
        title: "成果产出",
        content: "完成报价系统设计，大幅减少销售与客户之间的反复沟通成本。",
        images: [],
      },
    ],
    sectionsEn: [
      {
        title: "Background",
        content: "Designed quotation structure: base price + additional processes, MOQ rules, exchange rate settlement to reduce back-and-forth communication.",
        images: [],
      },
      {
        title: "My Responsibilities",
        content: "- Created B2B cooperation description (dealers/wholesalers/fleets/OEM)\n- Improved inquiry communication efficiency\n- CN/EN/RU adaptation ensuring clear, professional, actionable info",
        images: [],
      },
      {
        title: "Deliverables",
        content: "Completed quotation system design, significantly reducing communication costs between sales and customers.",
        images: [],
      },
    ],
  },
