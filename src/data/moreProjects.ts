...
export const moreProjects: MoreProject[] = [
  {
    ...
    deliverables: [
      { title: '首页结构', titleEn: 'Homepage Structure', description: '个人主页四大功能分区，通过视觉层级引导用户聚焦头部内容', descriptionEn: 'Four functional zones on personal homepage, using visual hierarchy to guide user focus to the header', images: ['/6808cb24-3096-402b-b4de-774cc0a5bb59.png'], layout: 'single' as const },
      { title: '动态浏览与转存', titleEn: 'Feed Browsing & Repost', description: '整体以白色为主，紫色按钮作为转化引导，信息层级归纳减少视觉干扰', descriptionEn: 'White-dominant layout with purple buttons as conversion guides, reducing visual noise through information hierarchy', images: ['/a423afd6-13ba-4ed2-880e-5e167b7f0f8b.png'], layout: 'single' as const },
      { title: '发布图文流程', titleEn: 'Publish Flow', description: '参照微信朋友圈发布样式降低学习成本，非常用设置收起处理，减少操作负担', descriptionEn: 'Modeled after WeChat Moments publishing to lower learning curve, collapsing infrequent settings to reduce cognitive load', images: ['/5011d02c-a7c3-43b1-a406-e6addd6bf14d.png'], layout: 'single' as const },
      { title: '工具页', titleEn: 'Tools Page', description: '紫色卡片聚焦核心数据，订单状态icon与线性操作入口形成明显对比', descriptionEn: 'Purple cards highlight core data, order status icons contrast clearly with linear action entries', images: ['/718e38a0-849c-4a78-9549-0aad7e254b27.png'], layout: 'single' as const },
      { title: '开单流程', titleEn: 'Order Creation Flow', description: '通过需求信息梳理与层级划分，让用户交互流程视觉聚焦到最关注的信息', descriptionEn: 'Through information sorting and hierarchy, user interaction visually focuses on the most important information', images: ['/d7c506d3-9dbd-4c7e-a60c-9ef6ed3041dd.png'], layout: 'single' as const },
      { title: '人人掌柜 · 三档会员体系', titleEn: 'Renren Shopkeeper · Three-Tier Membership', description: '暗色背景强化品质感，三档掌柜icon与色彩保持低饱和统一，避免视觉混乱', descriptionEn: 'Dark background reinforces premium feel, three-tier icons maintain low-saturation unity to avoid visual clutter', images: ['/lovable-uploads/d6ff3886-8744-4c37-8997-7a4fea0ae064.png'], layout: 'single' as const },
      { title: '收益中心与会员认证', titleEn: 'Earnings Center & Membership Certification', description: '对合理信息减噪，主次信息对比突出，保持视觉一致性', descriptionEn: 'Reducing noise on relevant information, emphasizing primary vs secondary content, maintaining visual consistency', images: ['/9ba46224-7df0-455a-a44b-bce68a5f7353.png'], layout: 'single' as const },
      { title: '全量页面总览 · Web版延伸', titleEn: 'Full Page Overview · Web Extension', description: 'App完整页面总览，及PC Web版货源管理系统界面', descriptionEn: 'Complete App page overview and PC Web supply management system interface', images: ['/683f63e2-623f-4895-bd7c-6414834642fc.png'], layout: 'single' as const },
    ],
    deliverablesEn: [
