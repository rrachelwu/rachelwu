...
const ProjectSection: React.FC<{ project: MoreProject }> = ({ project }) => {
  ...
  return (
    <article className="mb-20 last:mb-0">
      ...
      <div className="mb-8 flex flex-wrap gap-x-8 gap-y-3 text-sm border-y border-border py-5">
        ...
        <div>
          <span className="text-muted-foreground">{t('公司', 'Company')}</span>
          <p className="font-medium mt-0.5">{language === 'zh' ? project.company : project.companyEn}</p>
        </div>
        <div>
      ...
      <div className="container max-w-4xl">
        ...
        <div className="divide-y divide-border">
          {moreProjects.map((project) => (
            <div key={project.id} className="pt-16 first:pt-0">
